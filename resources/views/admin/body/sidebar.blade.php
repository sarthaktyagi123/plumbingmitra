			...
			<ul class="metismenu" id="menu">
				...
				<li>
					<a href="javascript:;" class="has-arrow">
						...
						<div class="menu-title">parent Category Master</div>
					</a>
					<ul>
              ...
              @if(Auth::user()->can('product.menu'))
				<li>
					<a href="javascript:;" class="has-arrow">
						...
						<div class="menu-title">Product Manage master</div>
					</a>
					<ul>
...
@endif
				...
				<li>
					<a href="javascript:;" class="has-arrow">
						...
						<div class="menu-title">Banner Manage master</div>
					</a>
					<ul>
...
@if(Auth::user()->can('coupon.menu'))
				<li>
					<a href="javascript:;" class="has-arrow">
						...
						<div class="menu-title">loyalty System Master(coupon master)</div>
					</a>
					<ul>
...
@if(Auth::user()->can('area.menu'))
				<li>
					<a href="javascript:;" class="has-arrow">
						...
						<div class="menu-title">Shipping Area Master </div>
					</a>
					<ul>
...
@endif
				...
				<li class="menu-label">testing</li>
