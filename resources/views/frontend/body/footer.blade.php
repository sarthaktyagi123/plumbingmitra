                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="position-relative newsletter-inner">
                            ...
                            <img src="{{ asset('frontend/assets/imgs/banner/popup-1.png') }}" alt="newsletter" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                            ...
                            @else
                                <a href="index.html" class="mb-15"><img src="{{ asset('path/to/default/logo.png') }}" alt="default logo" /></a>
                            @endif
...
<li><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-clock.svg') }}" alt="" /><strong>Hours:</strong><span>10:00 - 18:00, Mon - Sat</span></li>
        ...
        <div class="container pb-30 wow animate__animated animate__fadeInUp" data-wow-delay="0">
            <div class="row align-items-center">
                ...
                @else
                    <p class="font-sm mb-0">&copy; 2022, <strong class="text-brand">Ecommerce</strong> - Default Copyright</p>
                @endif    
               </div>
